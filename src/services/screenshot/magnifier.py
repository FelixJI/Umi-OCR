...
class Magnifier(QWidget):
    ...
    def update_position(self, screen_pos: QPoint, source_image: QPixmap) -> None:
        """
        更新放大镜位置和图像
        ...
        # 计算放大镜显示位置(避免遮挡鼠标)
        magnifier_pos = self._calculate_magnifier_position(screen_pos)
    ...
    def paintEvent(self, event) -> None:
        ...
        source_rect = QRect(
            self._screen_pos.x() - half_size,
            self._screen_pos.y() - half_size,
