...
class Ui_FloatingBar(object):
    def setupUi(self, FloatingBar):
        if not FloatingBar.objectName():
            FloatingBar.setObjectName(u"FloatingBar")
        FloatingBar.resize(50, 200)
        FloatingBar.setStyleSheet(u"#FloatingBar {\n"
...
"}")
        ...
        self.lbl_grip.setObjectName(u"lbl_grip")
    ...
    def retranslateUi(self, FloatingBar):
        FloatingBar.setWindowTitle(QCoreApplication.translate("FloatingBar", u"\u60ac\u6d6e\u5de5\u5177\u680f", None))
#if QT_CONFIG(tooltip)
        self.btn_screenshot.setToolTip(QCoreApplication.translate("FloatingBar", u"\u622a\u56fe OCR", None))
#endif // QT_CONFIG(tooltip)
        self.btn_screenshot.setText(QCoreApplication.translate("FloatingBar", u"\U0001f4f7", None))
#if QT_CONFIG(tooltip)
        self.btn_clipboard.setToolTip(QCoreApplication.translate("FloatingBar", u"\u526a\u8d34\u677f OCR", None))
#endif // QT_CONFIG(tooltip)
        self.btn_clipboard.setText(QCoreApplication.translate("FloatingBar", u"\U0001f4cb", None))
#if QT_CONFIG(tooltip)
        self.btn_batch.setToolTip(QCoreApplication.translate("FloatingBar", u"\u6279\u91cf OCR", None))
#endif // QT_CONFIG(tooltip)
        self.btn_batch.setText(QCoreApplication.translate("FloatingBar", u"\U0001f4c2", None))
#if QT_CONFIG(tooltip)
        self.btn_settings.setToolTip(QCoreApplication.translate("FloatingBar", u"\u8bbe\u7f6e", None))
#endif // QT_CONFIG(tooltip)
        self.btn_settings.setText(QCoreApplication.translate("FloatingBar", u"\u2699\ufe0f", None))
        self.lbl_grip.setText(QCoreApplication.translate("FloatingBar", u"\u283f", None))
    # retranslateUi
