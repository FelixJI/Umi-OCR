...
class SettingsSearch(QObject):
    ...
    def _get_searchable_items(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            {
                "key": "ocr.paddle.cpu_threads",
                "label": "CPU 线程数",
                "description": "OCR 识别时的 CPU 线程数",
            },
            {
                "key": "ocr.paddle.lang",
                "label": "识别语言",
                "description": "OCR 识别的语言类型",
            },
            {
            ...
            # 云服务配置
            {
                "key": "ocr.baidu.api_key",
                "label": "百度云 API Key",
                "description": "百度云 OCR 服务 API 密钥",
            },
            {
                "key": "ocr.baidu.secret_key",
                "label": "百度云 Secret Key",
                "description": "百度云 OCR 服务密钥",
            },
            {
                "key": "ocr.tencent.secret_id",
                "label": "腾讯云 Secret ID",
                "description": "腾讯云 OCR 服务密钥 ID",
            },
            {
                "key": "ocr.aliyun.access_key_id",
                "label": "阿里云 Access Key ID",
                "description": "阿里云 OCR 服务访问密钥 ID",
            },
            # 界面配置
            {
                "key": "ui.language",
            ...
            {
                "key": "ui.theme.font_size",
                "label": "字体大小",
                "description": "界面文字大小",
            },
            {
                "key": "ui.show_tray_icon",
                "label": "显示托盘图标",
                "description": "是否在系统托盘显示图标",
            },
            {
                "key": "ui.minimize_to_tray",
                "label": "最小化到托盘",
                "description": "最小化时是否隐藏到托盘",
            },
            {
                "key": "ui.close_to_tray",
                "label": "关闭到托盘",
                "description": "关闭窗口时是否隐藏到托盘",
            },
            # 快捷键配置
            {
                "key": "hotkeys.screenshot",
                "label": "截图快捷键",
                "description": "触发截图 OCR 的快捷键",
            },
            {
                "key": "hotkeys.clipboard",
                "label": "剪贴板快捷键",
                "description": "触发剪贴板 OCR 的快捷键",
            },
            {
                "key": "hotkeys.batch",
                "label": "批量识别快捷键",
                "description": "批量 OCR 快捷键",
            },
            {
                "key": "hotkeys.show_hide",
                "label": "显示/隐藏窗口",
                "description": "显示或隐藏主窗口的快捷键",
            },
            # 导出配置
            {
                "key": "export.default_format",
                "label": "默认导出格式",
                "description": "识别结果默认导出的文件格式",
            },
            {
                "key": "export.auto_copy",
                "label": "自动复制到剪贴板",
                "description": "识别完成后自动复制结果到剪贴板",
            },
            {
                "key": "export.export_dir",
                "label": "导出目录",
                "description": "默认导出文件的保存目录",
            },
            # 系统配置
            {
            ...
            {
                "key": "system.startup_launch",
                "label": "开机自启",
                "description": "系统启动时自动运行 Umi-OCR",
            },
            {
                "key": "system.http_server_enabled",
                "label": "启用 HTTP 服务",
                "description": "是否启用 HTTP API 服务",
            },
            {
                "key": "system.http_server_port",
                "label": "HTTP 服务端口",
                "description": "HTTP API 服务监听端口",
            },
            # 任务配置
            {
                "key": "task.max_workers",
                "label": "最大并发数",
                "description": "同时执行的最大 OCR 任务数",
            },
            {
                "key": "task.max_retry",
                "label": "最大重试次数",
